...
| **Dark Mode** | âŒ Never | Brand decision |
| **Fast Track** | âŒ Never | Not offered |
...
### 2026-06-23 — Add Lect. (Dr.) Ayşegül Akkaya to Editorial Board
- **Changed:** Added Lect. (Dr.) Ayşegül Akkaya to the editorial board
- **Reason:** User request to expand the international board
- **Files:** EDITORIAL_BOARD.md, editorial-board.html, editorial-portfolio.html, ssets/images/editorial-board/aysegul-akkaya.webp
- **Commit:** *Pending*
...
|---|---|---|
| Institutional emails missing for EIC (Dr. Nusrat) and ME (Amir Hashmi) | â³ Pending | High |
| Complete postal addresses needed for some board members | â³ Pending | High |
| Individual article PDF links needed in archive | â³ Pending | Medium |
| ISSN placeholder needs replacing when numbers arrive | â³ Waiting on ISSN | High |
| Google indexing: 7 of 27 pages indexed | ðŸ”„ In progress | Medium |
...
| **International Members** | 2 (Dr. Mary Lou Frank ðŸ‡ºðŸ‡¸, Prof. Jyotirmaya Thakur ðŸ‡¬ðŸ‡§) | 2026-06-22 |
