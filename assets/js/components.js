...
<header class="site-header" id="site-header" role="banner">
  <div class="container header-inner">
    ...
    <div class="header-actions">
      <a href="/call-for-papers.html" class="btn-submit desktop-only" id="nav-submit-btn">
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <nav class="footer-links" aria-label="Journal links">
          ...
          <a href="print-archive.html">Print Archive</a>
        </nav>
      </div>
    ...
    <div class="footer-bottom">
      <div style="display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:10px;flex-wrap:wrap;">
        <a href="https://creativecommons.org/licenses/by-nc/4.0/" target="_blank" rel="license noopener" style="display:inline-flex;align-items:center;">
          <img src="assets/images/logo/cc-by-nc-4-0.webp" alt="CC BY-NC 4.0 Badge" style="border:0;height:24px;width:auto;">
        </a>
